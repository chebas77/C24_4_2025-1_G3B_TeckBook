...
import portalImage from "./assets/portal.png"; // Mantener la referencia a la imagen original
    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.left}>
        <div style={styles.formBox}>
          ...
          <p style={styles.subtitle}>Inicia sesión con tus credenciales institucionales</p>
          ...
          <div style={styles.form}>
            ...
            >
              <span style={styles.buttonContent}>
                Ingresar
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={styles.arrowIcon}>
                  <path d="M5 12h14" />
          ...
          <button style={styles.googleButton}>
            ...
            <span style={styles.googleButtonText}>Ingresa con tu correo de Tecsup</span>
          </button>
      ...
      <div style={styles.right}>
        ...
        <div style={styles.infoCard}>
          ...
          <p style={styles.infoText}>
            Accede a todos tus recursos educativos, calificaciones y material de estudio en un solo lugar.
          </p>
        </div>
      </div>
    </div>
