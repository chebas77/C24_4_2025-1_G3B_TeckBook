        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/", "/oauth2/**", "/login/**", "/api/public/**",
                                                                "/error")
                                                .permitAll()

                                                // 🔥 ENDPOINTS DE AUTENTICACIÓN PÚBLICOS
                                                .requestMatchers("/api/usuarios/register", "/api/usuarios/login")
                                                .permitAll()
                                                ...
                                                .requestMatchers("/api/usuarios/me", "/api/usuarios/{id}")
                                                .authenticated()
                                                .requestMatchers("/api/auth/user", "/api/auth/logout",
                                                                "/api/auth/token/status")
                                                .authenticated()
                                                .requestMatchers("/api/upload/**").authenticated()
                                                .requestMatchers("/api/aulas/**").authenticated() // 🆕 NUEVO
